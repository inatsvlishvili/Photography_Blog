    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagePhotoCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PageImageName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedateTime = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PagePhotoCategoryId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PagePhotos_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PagePhotos_PagePhotoCategories_PagePhotoCategoryId",
                        column: x => x.PagePhotoCategoryId,
                        principalTable: "PagePhotoCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PagePhotos_Photographers_PhotographerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Videos_Photographers_PhotographerId",
                        column: x => x.PhotographerId,
                        principalTable: "Photographers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagePhotos_CategoryId",
                table: "PagePhotos",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PagePhotos_PagePhotoCategoryId",
                table: "PagePhotos",
                column: "PagePhotoCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PagePhotos_PhotographerId",
                table: "PagePhotos",
